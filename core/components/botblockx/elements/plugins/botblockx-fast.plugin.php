<?php
/* bot_blocker_top.php
   05 Aug 08 started - this slower version will block all bad bots, whilst letting ALL good bots through
   ...
   Alex Kemp
   modem-help.co.uk
   Download: http://download.modem-help.co.uk/non-modem/PHP/Rogue-Bot-Blocking/
*/
// -------------- Start blocking badly-behaved bots : top code -------
// The following will be useful for bug-checking (do not use on a live server):
   error_reporting( E_ALL );

   if( !defined('_B_SERVER_ROOT')) define('_B_SERVER_ROOT', '/full/server/path/to/script/root');
   if( !defined('_B_DIRECTORY'))   define('_B_DIRECTORY',    _B_SERVER_ROOT .'/block/');
   if( !defined('_B_LOGFILE'))     define('_B_LOGFILE',     'ipblock.log');
   if( !defined('_B_LOGMAXLINES')) define('_B_LOGMAXLINES',  1000 );
   if( !defined('_L_DIRECTORY'))   define('_L_DIRECTORY',    _B_SERVER_ROOT .'/logs/');
   ...
   $bTotVisit  = 500;   // tot visits within $bStartOver (0==no slow-scraper block)
   $bStartOver = 43200; // secs, default 12 hours; restart tracking
