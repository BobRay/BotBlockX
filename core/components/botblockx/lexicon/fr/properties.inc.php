...
/* BotBlockX Property Description strings */
...
$_lang['mc_cssfile_desc'] = '(optional) Name of CSS file to use, or `` for no CSS file; default: botblockx.css. File should be in assets/botblockx/css/ directory';
...
$_lang['mc_parentid_desc'] = '(optional) Folder id where new documents are stored; default: BotBlockX folder.';
