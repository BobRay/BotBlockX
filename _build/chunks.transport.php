<?php
/**
 * Utility snippet for BotBlockX development
 *
...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/botblockx',
    'source_assets' => $root . 'assets/components/botblockx',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/botblockx/docs/',
);
unset($root);
...
if (! $category) {
    ...
    $category->set('category','BotBlockX');
}
